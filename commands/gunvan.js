...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('gunvan')
        .setDescription('Mostra informações sobre a Van de Armas (Gun Van) do GTA Online.'),

    async execute(interaction) {
        // Criando a Embed em azul marinho com a imagem hospedada
        const embed = new EmbedBuilder()
            ...
            .addFields(
                { name: '📍 Localização de Hoje', value: 'Utilize o site [GTAWeb.eu](https://gtaweb.eu/) ou consulte o mapa diário para ver a posição exata hoje!', inline: false },
                { name: '🛡️ O que ela oferece?', value: '• Armas com descontos exclusivos\n• Coletes balísticos e explosivos\n• Itens rotativos', inline: false }
            )
